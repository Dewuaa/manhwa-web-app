      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {displayList.map((manga, i) => (
          <Link
            ...
            className="flex gap-4 bg-gray-900/40 border border-white/5 p-2 rounded-xl hover:bg-gray-800/80 hover:border-white/10 transition-all cursor-pointer group"
          >
            ...
            <div className="flex-1 py-1 min-w-0">
              <div className="flex justify-between items-start">
                <h4 className="text-gray-200 font-bold text-sm truncate pr-2 group-hover:text-blue-400 transition-colors">
                  {manga.title}
                </h4>
                <span className="text-[10px] text-gray-500 whitespace-nowrap bg-white/5 px-1.5 py-0.5 rounded">
